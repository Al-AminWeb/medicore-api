...
export const createDoctorZodSchema = z.object({
    ...
    doctor: z.object({
        ...
        qualification: z.string("Qualification is required").min(2, "Qualification must be at least 2 characters").max(200, "Qualification must be at most 200 characters"),
